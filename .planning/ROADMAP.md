...
- [x] **Phase 17: Golden Dataset & Retrieval Evaluation** - JSONL schema and pure Java retrieval metrics
...
Plans:
- [x] 17-01-PLAN.md - Golden dataset JSONL schema and loader
- [x] 17-02-PLAN.md - Pure Java retrieval metrics (Precision@k, Recall@k, MRR, NDCG)
- [x] 17-03-PLAN.md - EvaluationService and CLI command with segmented reporting
...
| 17. Golden Dataset & Retrieval | v0.4 | 3/3 | Complete | 2026-01-26 |
