...
/**
 * Cross-encoder reranking service that re-scores search candidates using an ONNX-based
 * scoring model (ms-marco-MiniLM-L-6-v2).
 *
 * <p>Takes RRF hybrid search candidates and a query, scores each query-passage pair
 * via the cross-encoder, then returns results sorted by reranking score descending.
 * Respects {@code maxResults} and optional {@code minScore} threshold.
 *
