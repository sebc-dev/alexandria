 ...
 *
 * <p>Scores each candidate language by counting how many of its characteristic patterns appear in
 * the code. Returns the highest-scoring language if the score is at least 2, otherwise returns
 * {@code "unknown"}.
 */
public final class LanguageDetector {

  private static final Map<String, List<String>> LANGUAGE_PATTERNS =
      Map.ofEntries(
          Map.entry(
              "java",
              List.of(
          ...
          Map.entry(
              "python",
              List.of("def ", "import ", "from ", "self.", "if __name__", "print(", "elif ")),
          Map.entry(
              "javascript",
              List.of(
                  "const ",
