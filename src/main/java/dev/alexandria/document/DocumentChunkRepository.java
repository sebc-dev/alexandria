...
public interface DocumentChunkRepository extends JpaRepository<DocumentChunk, UUID> {
    ...
    /**
     * Batch-updates the {@code source_id} column for chunks matching the given embedding IDs.
     * Called after {@code embeddingStore.addAll()} to link newly stored chunks to their source.
     *
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    void updateSourceIdBatch(@Param("sourceId") UUID sourceId, @Param("embeddingIds") String[] embeddingIds);
