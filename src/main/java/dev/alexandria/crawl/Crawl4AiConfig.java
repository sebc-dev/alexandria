 ...
 *
 * <p>Timeouts are externalized via {@code alexandria.crawl4ai.*} properties. The client defaults to
 * JSON content type and is qualified as {@code "crawl4AiRestClient"}.
 */
@Configuration
