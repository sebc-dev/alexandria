 ...
 *
 * <p>Created and updated by {@link CrawlProgressTracker} during crawl execution. Each mutation
 * produces a new record (value semantics for thread safety).
 *
...
public record CrawlProgress(
  ...
  /**
   * Crawl progress status, independent of {@link dev.alexandria.source.SourceStatus} to avoid a
   * package cycle between crawl and source packages.
   */
  public enum Status {
    CRAWLING,
    COMPLETED,
