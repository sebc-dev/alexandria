...
class DocumentChunkDataTest {
    ...
    void toMetadataIncludesVersionWhenPresent() {
        var chunk = new DocumentChunkData(
                TEXT, SOURCE_URL, SECTION_PATH, ContentType.PROSE, LAST_UPDATED,
                null, "3.5", null);
    ...
    void toMetadataIncludesBothVersionAndSourceNameWhenPresent() {
        var chunk = new DocumentChunkData(
                TEXT, SOURCE_URL, SECTION_PATH, ContentType.CODE, LAST_UPDATED,
                "java", "4.0", "Spring Framework");
