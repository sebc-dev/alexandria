...
class UrlNormalizerTest {
  ...
  void isSameSiteMatchesSameHost() {
    boolean result =
        UrlNormalizer.isSameSite("https://docs.spring.io/guide", "https://docs.spring.io/other");
  ...
  void isSameSiteRejectsDifferentHost() {
    boolean result =
        UrlNormalizer.isSameSite("https://docs.spring.io/guide", "https://github.com/spring");
    assertThat(result).isFalse();
  }

  @Test
  void isSameSiteRejectsDifferentScheme() {
    boolean result = UrlNormalizer.isSameSite("https://docs.spring.io", "http://docs.spring.io");
    assertThat(result).isFalse();
  }
}
