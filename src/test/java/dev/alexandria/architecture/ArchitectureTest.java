...
class ArchitectureTest {
  ...
  static final ArchRule features_should_not_depend_on_adapters =
      noClasses()
          .that()
          .resideInAnyPackage("..ingestion..", "..search..", "..source..", "..document..")
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("..mcp..", "..api..")
  ...
  static final ArchRule no_package_cycles =
      slices().matching("dev.alexandria.(*)..").should().beFreeOfCycles().allowEmptyShould(true);
}
