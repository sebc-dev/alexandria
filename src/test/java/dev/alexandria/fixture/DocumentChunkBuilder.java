...
/**
 * Lightweight test builder for the {@link DocumentChunk} JPA entity. Provides sensible defaults so
...
public final class DocumentChunkBuilder {
  ...
  private String metadata =
      "{\"source_url\":\"https://docs.example.com\",\"section_path\":\"getting-started\"}";
