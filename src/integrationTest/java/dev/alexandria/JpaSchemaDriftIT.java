...
/**
 * Compensates for ddl-auto=none by verifying each JPA entity can be persisted and read back against
 * the Flyway schema. Catches entity ↔ migration drift at test time rather than runtime.
 */
@Transactional
class JpaSchemaDriftIT extends BaseIntegrationTest {
  ...
  @Autowired private IngestionStateRepository ingestionStateRepository;
