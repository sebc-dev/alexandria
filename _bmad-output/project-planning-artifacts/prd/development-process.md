...
>
> La documentation détaillée de la stratégie d'assurance qualité et des outils (ts-arch, ESLint, CodeRabbit) est maintenant disponible dans :
...
> - Configurations complètes (.coderabbit.yaml, .eslintrc.js, architecture.spec.ts)
