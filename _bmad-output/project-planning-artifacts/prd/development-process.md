...
> **📚 Documentation complète déplacée**
>
> La documentation détaillée de la stratégie d'assurance qualité et des outils (Dependency Cruiser, ESLint Plugin Boundaries, CodeRabbit) est maintenant disponible dans :
> **[Architecture > Tools & Automation > Code Quality Enforcement](../architecture/tools-and-automation/code-quality-enforcement.md)**
>
> Cette section contient une vue d'ensemble. Consultez la documentation architecture pour :
> - Configurations complètes (.coderabbit.yaml, eslint.config.js, .dependency-cruiser.js)
> - Règles AST-grep custom
