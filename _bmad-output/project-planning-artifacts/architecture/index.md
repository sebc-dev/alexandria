...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Tools & Automation](./tools-and-automation/)
    ...
    - [Code Quality Enforcement - Stratégie 3-Tiers](./tools-and-automation/code-quality-enforcement.md)
      - [ts-arch - Hard Enforcement](./tools-and-automation/code-quality-enforcement.md#tier-1-ts-arch---hard-enforcement-build-breaking)
      - [ESLint - Real-Time IDE Feedback](./tools-and-automation/code-quality-enforcement.md#tier-2-eslint---real-time-ide-feedback)
